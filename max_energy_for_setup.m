function [specific_rot_energy, rot_energy] = max_energy_for_setup(t_ring, D, b1, b2, rho, W, n, k, T, max_tensile_stress_allowable)
    ...
    [specific_rot_energy, rot_energy] = rotational_energy(t_ring,D,b1,b2,rho,W,L_spoke,n,omega_max);
